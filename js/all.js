...
DR_EXPLAIN.data_menu = {
    ...
    DREX_NODE_LINKS: ["index.htm","myenglish_guide.htm","thong_tin_gioi_thieu_ve_lop_hoc_vnpt__myenglish.htm","huong_dan_vao_lop_hoc_cua_toi_de_hoc_khoa_hoc_cua_lop__.htm","cac_buoc_hoc_tieng_anh_hieu_qua_trong_video_bai_hoc.htm","cach_on_hoc_tu_vung_hieu_qua__.htm","huong_dan_phuong_phap_hoc_myenglish_hieu_qua.htm","huong_dan_hoc_nang_cao_ky_nang_phat_am.htm","huong_dan_xem_ket_qua__tien_do_thuc_hien_khoa_hoc__.htm","huong_dan_hoc_ngoai_khoa_hoc_cua_lop__.htm","huong_dan_doi_mat_khau.htm"],
