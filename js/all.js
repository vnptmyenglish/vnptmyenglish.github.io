...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["MyEnglish Guide","A/ GIỚI THIỆU VỀ LỚP HỌC VNPT-MYENGLISH	","B/ HƯỚNG DẪN THỰC HIỆN KIỂM TRA ĐẦU VÀO","C/ HƯỚNG DẪN HỌC TRÊN MYENGLISH","D/HỖ TRỢ KỸ THUẬT","CÁCH THỨC HỌC TRONG LỚP HỌC ONLINE VNPT-MYENGLISH","ĐĂNG KÝ CHỌN LỚP (ĐỐI VỚI KHÁCH HÀNG CÁ NHÂN)	","I/ KIỂM TRA ĐẦU VÀO VỚI TRẮC NGHIỆM TỪ VỰNG (VOCAB LEVEL TEST)","II/ KIỂM TRA ĐẦU VÀO VỚI GOLIVE CHO HỌC VIÊN SỬ DỤNG GÓI CƯỚC PREMIUM/ PLATINUM","HƯỚNG DẪN HỌC CÁC BƯỚC HỌC HIỆU QUẢ	","CÁCH ÔN HỌC TỪ VỰNG HIỆU QUẢ","HƯỚNG DẪN PHƯƠNG PHÁP HỌC MYENGLISH HIỆU QUẢ","HƯỚNG DẪN HỌC NÂNG CAO KỸ NĂNG PHÁT ÂM","HƯỚNG DẪN VÀO LỚP HỌC CỦA TÔI ĐỂ HỌC KHÓA HỌC CỦA LỚP","HƯỚNG DẪN XEM KẾT QUẢ, TIẾN ĐỘ THỰC HIỆN KHÓA HỌC","HƯỚNG DẪN HỌC GOLIVE PHIÊN BẢN  WebRTC","HƯỚNG DẪN ĐỔI MẬT KHẨU","HƯỚNG DẪN TẢI ỨNG DỤNG MYENGLISH","HƯỚNG DẪN CHUNG","CHUẨN BỊ TRƯỚC GIỜ KIỂM TRA","HƯỚNG DẪN HỌC GOLIVE PHIÊN BẢN  WebRTC","HƯỚNG DẪN HỌC NGOÀI KHÓA HỌC CỦA LỚP"],
    DREX_NODE_LINKS: ["index.htm","a__gioi_thieu_ve_lop_hoc_vnpt_myenglish_.htm","b__huong_dan_thuc_hien_kiem_tra_dau_vao.htm","c__huong_dan_hoc_tren_myenglish.htm","d_ho_tro_ky_thuat.htm","cach_thuc_hoc_trong_lop_hoc_online_vnpt_myenglish.htm","dang_ky_chon_lop__doi_voi_khach_hang_ca_nhan__.htm","i__kiem_tra_dau_vao_voi_trac_nghiem_tu_vung__vocab_level_test_.htm","ii__kiem_tra_dau_vao_voi_golive_cho_hoc_vien_su_dung_goi_cuoc_premium__platinum.htm","huong_dan_hoc_cac_buoc_hoc_hieu_qua_.htm","cach_on_hoc_tu_vung_hieu_qua.htm","huong_dan_phuong_phap_hoc_myenglish_hieu_qua.htm","huong_dan_hoc_nang_cao_ky_nang_phat_am.htm","huong_dan_vao_lop_hoc_cua_toi_de_hoc_khoa_hoc_cua_lop.htm","huong_dan_xem_ket_qua__tien_do_thuc_hien_khoa_hoc.htm","huong_dan_hoc_golive_phien_ban___webrtc_2.htm","huong_dan_doi_mat_khau.htm","huong_dan_tai_ung_dung_myenglish.htm","huong_dan_chung.htm","chuan_bi_truoc_gio_kiem_tra.htm","huong_dan_hoc_golive_phien_ban___webrtc_1.htm","huong_dan_hoc_ngoai_khoa_hoc_cua_lop.htm"],
    DREX_NODE_CHILD_START: [1,5,7,9,16,18,18,18,18,21,21,21,21,21,22,22,22,22,22,22,22,22],
    DREX_NODE_CHILD_END: [5,7,9,16,18,18,18,18,21,21,21,21,21,22,22,22,22,22,22,22,22,22],
    DREX_MENU_TYPE: 2,
